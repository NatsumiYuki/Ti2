...
public class LanguageServiceExample {
    private static final String ENDPOINT = "https://natsumi.cognitiveservices.azure.com/";
    private static final String API_KEY = "e5678bf601e4aca88ab82d843298ed";
    
    public static void main(String[] args) throws Exception {
        String text = "Eu vou me mat!";
